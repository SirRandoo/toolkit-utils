...
namespace SirRandoo.ToolkitUtils.IncidentHelpers
{
    public class BuyPawnHelper : IncidentHelperVariables
    {
        ...
        public override bool IsPossible(string message, Viewer viewer, bool separateChannel = false)
        {
            ...
            {
                CommandBase.SendCommandMessage(viewer.username, "TKUtils.Responses.Buy.HasPawn".Translate());
                return false;
            }
            ...
            if(map == null)
            {
                CommandBase.SendCommandMessage(viewer.username, "TKUtils.Responses.Buy.NoMap".Translate());
                return false;
            }
            ...
            if(segments.Length > 0)
            {
                ...
                if(raceDef != null)
                {
                    ...
                    {
                        CommandBase.SendCommandMessage(viewer.username, "TKUtils.Responses.Buy.OnlyHuman".Translate());
                        return false;
                    }
                ...
                {
                    CommandBase.SendCommandMessage(viewer.username, "TKUtils.Responses.Buy.NoRace".Translate(race.Named("QUERY")));
                    return false;
                }
            }
