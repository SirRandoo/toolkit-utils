...
namespace SirRandoo.ToolkitUtils.Harmony
{
    ...
    internal static class ItemWindowPatch
    {
        private static IEnumerable<MethodBase> TargetMethods()
        {
            yield return AccessTools.Method(typeof(StoreItemsWindow), nameof(StoreItemsWindow.PostClose));
        }

        [SuppressMessage("ReSharper", "InconsistentNaming")]
        private static void Prefix([NotNull] List<ThingDef> ___cachedTradeables, List<int> ___tradeablesPrices)
        {
