...
[EnumExtensions] public enum NameStrategies { Is, Not, Contains, EndsWith, StartsWith }
...
public class NameConstraint : ConstraintBase
{
    ...
    public NameConstraint()
    {
        ...
        _strategyOptions = NameStrategiesExtensions.GetValues()
           .Select(t => new FloatMenuOption($"TKUtils.PurgeMenu.{t.ToStringFast()}".Localize(), () => NameStrategy = t))
           .ToList();
    }
    ...
    public NameStrategies NameStrategy
    {
        ...
        set
        {
            ...
            {
                string nameStrategyText = value.ToStringFast();
