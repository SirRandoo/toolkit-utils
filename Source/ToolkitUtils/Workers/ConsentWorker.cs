...
public class ConsentWorker
{
    ...
    ///     consent
    /// </param>
    public bool GetAskeeStatus(string username) => _consentData.TryGetValue(username.ToLowerInvariant(), out ConsentContext context) && context.Agreed;
    ...
    /// </summary>
    /// <param name="username">The person that was asked for consent</param>
    public bool GetAskerStatus(string username) => GetAskeeStatus(username);
