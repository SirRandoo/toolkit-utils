...
public class LevelPawnSettingEmbed : IEventSettings
{
    ...
    public void Draw(Rect canvas, float preferredHeight)
    {
        ...
        LabelDrawer.Draw(label, "TKUtils.Fields.LevelSkillMultiplier".Localize());

        if (FieldDrawer.DrawNumberField(field, out float value, ref _buffer, ref _bufferValid, 0.5f, 5f))
        {
