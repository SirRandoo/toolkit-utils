...
namespace SirRandoo.ToolkitUtils.Incidents
{
    public class Childhood : IncidentVariablesBase
    {
        ...
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            backstory = BackstoryDatabase.allBackstories.Values.Where(b => b.slot == BackstorySlot.Childhood).Where(b => !WouldBeViolation(b)).InRandomOrder().FirstOrDefault();
        ...
        public override void Execute()
        {
            ...
            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.Childhood.Complete".LocalizeKeyed(backstory.TitleCapFor(pawn.gender)));

            Find.LetterStack.ReceiveLetter(
                "TKUtils.BackstoryLetter.Title".Localize(),
                "TKUtils.BackstoryLetter.ChildhoodDescription".LocalizeKeyed(Viewer.username, previous.TitleCapFor(pawn.gender), backstory.TitleCapFor(pawn.gender)),
