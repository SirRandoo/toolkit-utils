...
public class Wear : IncidentVariablesBase
{
    ...
    private void FinalizeTransaction(Thing thing, SpawnCode code, bool spawned)
    {
    ...
    private void SendUnquippableNotifications(Thing thing, bool spawned)
    {
    ...
    private void SendLockedApparelNotifications(Thing thing, bool spawned)
    {
        MessageHelper.SendConfirmation(
            Viewer.username,
    ...
    private void SendNoPartsNotifications(Thing thing, bool spawned)
    {
        MessageHelper.SendConfirmation(
            Viewer.username,
    ...
    private void SendSuccessNotification(Thing thing, bool spawned)
    {
