...
using SirRandoo.ToolkitUtils.Utils.Basket;
...
public static class Basket
{
    ...
    public static bool RegisterEggFor(string user, IEasterEgg egg)
    {
    ...
    public static bool UnregisterEggFor(string user) => Eggs.Remove(user);
    ...
    /// </returns>
    [CanBeNull]
    public static IEasterEgg GetEggFor(string user) => !Eggs.TryGetValue(user.ToLowerInvariant(), out IEasterEgg egg) ? null : egg;
    ...
    public static bool TryGetEggFor(string user, out IEasterEgg egg)
    {
        egg = GetEggFor(user);
