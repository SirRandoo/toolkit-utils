...
namespace ToolkitUtils.Utils
{
    public abstract class ConsensualCommand : CommandBase
    {
        ...
        public override void RunCommand([NotNull] ITwitchMessage twitchMessage)
        {
            ...
            switch (argument.ToLowerInvariant())
            {
                ...
                default:
                    ...
                    {
                        MessageHelper.ReplyToUser(twitchMessage.Username, "TKUtils.InvalidViewerQuery".Translate(worker.GetLast()));
                    }
        ...
        {
            MessageHelper.ReplyToUser(asker, "TKUtils.RequestDeclined".Translate(askee));
        }

        protected virtual void ProcessAcceptInternal([NotNull] string asker, [NotNull] string askee)
        {
            MessageHelper.ReplyToUser(asker, "TKUtils.RequestApproved".Translate(askee));
        }
        ...
        protected virtual void ProcessRequest([NotNull] string username, [NotNull] Viewer viewer)
        {
            ...
            {
                MessageHelper.ReplyToUser(username, "TKUtils.NoPawn".Translate(username));
            ...
            {
                MessageHelper.ReplyToUser(username, "TKUtils.PawnNotFound".Translate(viewer.username));
