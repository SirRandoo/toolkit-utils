...
namespace ToolkitUtils.IncidentSettings
{
    ...
    public class Backpack : IncidentHelperVariablesSettings, IEventSettings
    {
        ...
        public void Draw(Rect canvas, float preferredHeight)
        {
            ...
            listing.CheckboxLabeled("TKUtils.Item.Research.Label".TranslateSimple(), ref BuyItemSettings.mustResearchFirst, "TKUtils.Item.Research.Description".TranslateSimple());

            listing.CheckboxLabeled("TKUtils.Backpack.AutoEquip.Label".TranslateSimple(), ref AutoEquip, "TKUtils.Backpack.AutoEquip.Description".TranslateSimple());
