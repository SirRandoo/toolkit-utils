...
namespace ToolkitUtils.Workers
{
    ...
    public class EventTableWorker : TableWorker<TableSettingsItem<EventItem>>
    {
        ...
        private void LoadTranslations()
        {
            ...
            _karmaHeaderText = "TKUtils.Headers.Karma".TranslateSimple();

            _openSettingsText = "TKUtils.Buttons.Settings".TranslateSimple();

            _editEventNameTooltip = "TKUtils.EventTableTooltips.EditEventName".TranslateSimple();
            _closeEventNameTooltip = "TKUtils.EventTableTooltips.CloseEventName".TranslateSimple();
            _resetEventNameTooltip = "TKUtils.EventTableTooltips.ResetEventName".TranslateSimple();

            _eventCapText = "TKUtils.Fields.EventCap".TranslateSimple();
            _maxWagerText = "TKUtils.Fields.MaxWager".TranslateSimple();
