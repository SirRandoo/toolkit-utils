...
namespace ToolkitUtils.Workers
{
    public class ItemTableWorker : TableWorker<TableSettingsItem<ThingItem>>
    {
        ...
        private void LoadTranslations()
        {
            ...
            _categoryHeaderText = "TKUtils.Headers.Category".TranslateSimple();

            _quantityLimitText = "TKUtils.Fields.QuantityLimit".TranslateSimple();
            _isStuffText = "TKUtils.Fields.CanBeStuff".TranslateSimple();
            _karmaTypeText = "TKUtils.Fields.KarmaType".TranslateSimple();
            _purchaseWeightText = "TKUtils.Fields.Weight".TranslateSimple();
            _defaultKarmaTypeText = "TKUtils.Fields.DefaultKarmaType".TranslateSimple();
            _useKarmaTypeText = "TKUtils.Fields.UseKarmaType".TranslateSimple();
            _wearKarmaTypeText = "TKUtils.Fields.WearKarmaType".TranslateSimple();
            _equipKarmaTypeText = "TKUtils.Fields.EquipKarmaType".TranslateSimple();
            _isEquippableText = "TKUtils.Fields.CanEquip".TranslateSimple();
            _isUsableText = "TKUtils.Fields.CanUse".TranslateSimple();
            _isWearableText = "TKUtils.Fields.CanWear".TranslateSimple();

            _stackLimitTooltip = "TKUtils.ItemTableTooltips.ToStackLimit".TranslateSimple();
            _editItemNameTooltip = "TKUtils.ItemTableTooltips.EditItemName".TranslateSimple();
            _closeItemNameTooltip = "TKUtils.ItemTableTooltips.CloseItemName".TranslateSimple();
            _resetItemNameTooltip = "TKUtils.ItemTableTooltips.ResetItemName".TranslateSimple();
            _resetItemKarmaTooltip = "TKUtils.ItemTableTooltips.ResetItemKarma".TranslateSimple();
        }
