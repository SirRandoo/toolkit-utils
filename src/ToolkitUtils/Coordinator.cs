...
namespace ToolkitUtils
{
    ...
    {
        private static readonly IRimLogger Logger = new RimThreadedLogger("TKU.Coordinator");
        ...
        private void ProcessCoinReward()
        {
            ...
            if (currentMinute > 0 && currentMinute % 5 == 0 && _lastRefreshMinute != currentMinute)
            {
                ...
                Logger.Debug($"Refreshed viewers @ {DateTime.Now:T}");
            }
            ...
            Logger.Debug($"Awarded viewers coins @ {DateTime.Now:T}");
        }
        ...
        private static void ProcessNextIncident()
        {
            ...
            {
                Logger.Error($@"The incident ""{incident.def.defName}"" raised an exception", e);
            }
        }
