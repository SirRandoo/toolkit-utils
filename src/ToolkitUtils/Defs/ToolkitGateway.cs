...
namespace ToolkitUtils.Defs
{
    ...
    public class ToolkitGateway : Building
    {
        ...
        public override void TickLong()
        {
            ...
            {
                GenSpawn.Spawn(
                    PawnGenerator.GeneratePawn(shouldSpawnBoomRat ? DefDatabase<PawnKindDef>.GetNamed("Boomrat") : DefDatabase<PawnKindDef>.GetNamed("Rat")),
                    Position,
                    Map
                );
            }
