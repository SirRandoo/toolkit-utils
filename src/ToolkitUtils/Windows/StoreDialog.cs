...
namespace ToolkitUtils.Windows
{
    ...
    public class StoreDialog : Window
    {
        ...
        private string _TranslateSimple;
        ...
        private void GenerateFilters()
        {
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    Id = "Researched", IsUnfilteredFunc = ThingItemFilter.FilterByResearched, Label = "TKUtils.StoreFilters.Researched".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    Id = "Stackable", IsUnfilteredFunc = ThingItemFilter.FilterByStackable, Label = "TKUtils.StoreFilters.Stackable".TranslateSimple().CapitalizeFirst()
                }
            );

            _filterManager.RegisterFilter(
                FilterTypes.Stuff,
                new ThingItemFilter { Id = "Stuff", IsUnfilteredFunc = ThingItemFilter.FilterByStuff, Label = "TKUtils.StoreFilters.Stuff".TranslateSimple().CapitalizeFirst() }
            );

            _filterManager.RegisterFilter(
                FilterTypes.Stuff,
                new ThingItemFilter { Id = "NotStuff", IsUnfilteredFunc = ThingItemFilter.FilterByNotStuff, Label = "TKUtils.StoreFilters.NotStuff".TranslateSimple() }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    Id = "Disabled", IsUnfilteredFunc = ThingItemFilter.FilterByDisabled, Label = "TKUtils.StoreFilters.Disabled".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    Id = "Enabled", IsUnfilteredFunc = ThingItemFilter.FilterByEnabled, Label = "TKUtils.StoreFilters.Enabled".TranslateSimple().CapitalizeFirst()
                }
            );
        ...
        private void DoFilterMenu(Rect canvas)
        {
            ...
            Widgets.Label(new Rect(filterDialog.x + 8f, filterDialog.y + 5f, filterDialog.width - 30f, Text.LineHeight * LineScale).Rounded(), _TranslateSimple);
        ...
        private void GetTranslationStrings()
        {
            ...
            _TranslateSimple = "TKUtils.Headers.FilterDialog".TranslateSimple();
