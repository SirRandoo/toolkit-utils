            ...
            _broadcasterUserTypeMenu = new FloatMenu(
                new List<FloatMenuOption>
                {
                    new FloatMenuOption(
                        ...
                        () => TkSettings.BroadcasterCoinType = nameof(UserTypes.Broadcaster)
                    ),
                    new FloatMenuOption(
                        "TKUtils.BroadcasterUserType.Subscriber".TranslateSimple(),
                        () => TkSettings.BroadcasterCoinType = nameof(UserTypes.Subscriber)
                    ),
                    new FloatMenuOption("TKUtils.BroadcasterUserType.Vip".TranslateSimple(), () => TkSettings.BroadcasterCoinType = nameof(UserTypes.Vip)),
                    new FloatMenuOption(
                        "TKUtils.BroadcasterUserType.Moderator".TranslateSimple(),
                        () => TkSettings.BroadcasterCoinType = nameof(UserTypes.Moderator)
                    ),
                    new FloatMenuOption("None".TranslateSimple().CapitalizeFirst(), () => TkSettings.BroadcasterCoinType = nameof(UserTypes.None))
                }
            );
        }
