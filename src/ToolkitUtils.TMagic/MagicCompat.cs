...
namespace ToolkitUtils.TMagic
{
    ...
    public class MagicCompat : IMagicCompatibilityProvider
    {
        ...
        public string GetSkillDescription(string invoker, string query)
        {
            ...
            {
                return "TKUtils.NoPawn".TranslateSimple();
            }
            ...
            {
                builder.Append(ResponseHelper.MagicGlyph.AltText("TKUtils.PawnClass.Magic".TranslateSimple()));
                builder.Append(" ");
            ...
            builder.Append(ResponseHelper.DaggerGlyph.AltText("TKUtils.PawnClass.Might".TranslateSimple()));
            builder.Append(" ");
            builder.Append(description);
