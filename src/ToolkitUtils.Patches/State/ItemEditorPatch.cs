...
namespace ToolkitUtils.Patches
{
    ...
    {
        private static readonly IRimLogger Logger = new RimThreadedLogger("TKU.Patches.ItemEditor");
        ...
        private static void Postfix()
        {
            ...
            Logger.Info("Utils' item list didn't match Twitch Toolkit's; rebuilding list...");
