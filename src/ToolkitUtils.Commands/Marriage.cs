...
namespace ToolkitUtils.Commands
{
    public class Marriage : ConsensualCommand
    {
        ...
        protected override void ProcessAcceptInternal(string asker, string askee)
        {
            ...
            {
                MessageHelper.ReplyToUser(asker, "TKUtils.NoPawn".Translate(asker));
            ...
            {
                MessageHelper.ReplyToUser(asker, "TKUtils.PawnNotFound".Translate(askee));
            ...
            {
                MessageHelper.ReplyToUser(asker, "TKUtils.Marriage.NoSlots".TranslateSimple());
            ...
            Task.Run(
                async () =>
                {
                    await TaskExtensions.OnMainAsync(PerformMarriage, askerPawn, askeePawn);
                }
            );
        }
