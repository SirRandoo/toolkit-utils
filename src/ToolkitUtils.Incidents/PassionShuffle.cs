...
namespace ToolkitUtils.Incidents
{
    ...
    {
        private static readonly IRimLogger Logger = new RimThreadedLogger("TKU.Events.PassionShuffle");
        ...
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            if (passions <= 0)
            {
                MessageHelper.ReplyToUser(viewer.username, "TKUtils.PassionShuffle.None".TranslateSimple());
        ...
        public override void Execute()
        {
            ...
            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.PassionShuffle.Complete".TranslateSimple());

            Find.LetterStack.ReceiveLetter(
                "TKUtils.PassionShuffleLetter.Title".TranslateSimple(),
                "TKUtils.PassionShuffleLetter.Description".Translate(Viewer.username),
        ...
        private void ShuffleWithInterests()
        {
            ...
            while (interests.Any())
            {
                ...
                Logger.Warn("Exceeded 100 iterations while shuffling interests!");
