...
namespace ToolkitUtils.Incidents
{
    public class HealAll : IncidentVariablesBase
    {
        ...
        public override bool CanHappen(string msg, Viewer viewer)
        {
            ...
            {
                if (global::ToolkitUtils.IncidentSettings.HealAll.FairFights && pawn.mindState.lastAttackTargetTick > 0
        ...
        public override void Execute()
        {
            ...
            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.MassHealLetter.Description".TranslateSimple());

            Find.LetterStack.ReceiveLetter("TKUtils.MassHealLetter.Title".TranslateSimple(), "TKUtils.MassHealLetter.Description".TranslateSimple(), LetterDefOf.PositiveEvent);
        }
    }
}
