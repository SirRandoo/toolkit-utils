...
namespace ToolkitUtils.Incidents
{
    public class Adulthood : IncidentVariablesBase
    {
        ...
        public override void Execute()
        {
            ...
            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.Adulthood.Complete".Translate(_backstory.TitleCapFor(_pawn.gender)));

            Find.LetterStack.ReceiveLetter(
                "TKUtils.BackstoryLetter.Title".TranslateSimple(),
                "TKUtils.BackstoryLetter.AdulthoodDescription".Translate(
                    Viewer.username,
