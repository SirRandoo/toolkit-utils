...
namespace ToolkitUtils.Incidents
{
    public class HealMe : IncidentVariablesBase
    {
        ...
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            if (global::ToolkitUtils.IncidentSettings.HealMe.FairFights && _pawn!.mindState.lastAttackTargetTick > 0 && Find.TickManager.TicksGame < _pawn.mindState.lastAttackTargetTick + 1800)
            {
        ...
        private void NotifySuccess(string target)
        {
            ...
            if (!description.NullOrEmpty())
            {
                Current.Game.letterStack.ReceiveLetter(
                    "TKUtils.HealLetter.Title".TranslateSimple(),
