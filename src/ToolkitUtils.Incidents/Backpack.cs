...
namespace ToolkitUtils.Incidents
{
    ...
    {
        private static readonly IRimLogger Logger = new RimThreadedLogger("ToolkitUtils.Incidents.Backpack");
        ...
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            if (PurchaseHelper.TryGetUnfinishedPrerequisites(proxy.Thing.Thing, out List<ResearchProjectDef> projects))
            {
                MessageHelper.ReplyToUser(
                    viewer.username,
                    "TKUtils.ResearchRequired".Translate(proxy.Thing.Thing!.LabelCap.RawText, projects.Select(p => p.LabelCap.RawText).SectionJoin())
                );
        ...
        public override void Execute()
        {
            ...
            {
                Logger.Warn($"Backpack failed to execute with error message: {e.Message}");
            }
        }
        ...
        private sealed class PurchaseBackpackRequest
        {
            ...
            public void Spawn()
            {
                ...
                Find.LetterStack.ReceiveLetter(
                    ...
                    "TKUtils.BackpackLetter.Description".Translate(Quantity.ToString("N0"), Proxy.AsString(Quantity > 1), Purchaser.username),
