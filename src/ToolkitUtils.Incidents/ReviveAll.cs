...
namespace ToolkitUtils.Incidents
{
    ...
    public class ReviveAll : IncidentHelper
    {
        ...
        public override void TryExecute()
        {
            ...
            Find.LetterStack.ReceiveLetter("TKUtils.MassRevivalLetter.Title".TranslateSimple(), "TKUtils.MassRevivalLetter.Description".TranslateSimple(), LetterDefOf.PositiveEvent);
        }
    }
}
