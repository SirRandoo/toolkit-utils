...
using ToolkitUtils.Models.IncidentDatas;
            ...
            if (_worker.TryExecute(_params))
            {
                ...
                MessageHelper.ReplyToUser(
                    ...
                    _data.UseStoryteller
                        ? "TKUtils.Wagered.Storyteller".Translate(name, points)
                        : "TKUtils.Wagered.Complete".Translate(name, _wager.ToString("N0"), points)
                );
