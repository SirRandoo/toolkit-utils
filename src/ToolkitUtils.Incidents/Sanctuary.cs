...
namespace ToolkitUtils.Incidents
{
    public class Sanctuary : IncidentVariablesBase
    {
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            {
                MessageHelper.ReplyToUser(viewer.username, "TKUtils.InsufficientBalance".TranslateSimple());
        ...
        public override void Execute()
        {
            ...
            Find.LetterStack.ReceiveLetter("TKUtils.SanctuaryLetter.Title".TranslateSimple(), "TKUtils.SanctuaryLetter.Description".TranslateSimple(), LetterDefOf.PositiveEvent);

            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.Sanctuary.Complete".TranslateSimple());
        }
    }
}
