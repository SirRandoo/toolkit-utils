...
namespace ToolkitUtils.Incidents
{
    public class BuySurgery : IncidentVariablesBase
    {
        ...
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            {
                MessageHelper.ReplyToUser(viewer.username, "TKUtils.InvalidItemQuery".Translate(partQuery));
            ...
            {
                MessageHelper.ReplyToUser(viewer.username, "TKUtils.Surgery.HasNoSurgery".Translate(partQuery));
            ...
            if (!viewer.CanAfford(_appointment.Cost))
            {
                MessageHelper.ReplyToUser(
                    viewer.username,
                    "TKUtils.InsufficientBalance".Translate(_appointment.Cost.ToString("N0"), viewer.GetViewerCoins().ToString("N0"))
                );
            ...
            {
                MessageHelper.ReplyToUser(viewer.username, "TKUtils.Surgery.NoSlotAvailable".TranslateSimple());
        ...
        public override void Execute()
        {
            ...
            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.Surgery.Complete".Translate(_appointment.ThingDef.LabelCap));

            Find.LetterStack.ReceiveLetter(
                "TKUtils.SurgeryLetter.Title".TranslateSimple(),
                "TKUtils.SurgeryLetter.Description".Translate(Viewer.username, Find.ActiveLanguageWorker.WithDefiniteArticle(thing.LabelCap)),
