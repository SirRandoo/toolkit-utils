...
namespace ToolkitUtils.Incidents
{
    public class GenderSwap : IncidentVariablesBase
    {
        ...
        public override bool CanHappen(string msg, [NotNull] Viewer viewer)
        {
            ...
            MessageHelper.ReplyToUser(viewer.username, "TKUtils.GenderSwap.None".TranslateSimple());
        ...
        public override void Execute()
        {
            ...
            MessageHelper.SendConfirmation(Viewer.username, "TKUtils.GenderSwap.Complete".Translate(_pawn.gender.ToString()));

            Find.LetterStack.ReceiveLetter(
                "TKUtils.GenderSwapLetter.Title".TranslateSimple(),
                "TKUtils.GenderSwapLetter.Description".Translate(Viewer.username, _pawn.gender.ToString()),
